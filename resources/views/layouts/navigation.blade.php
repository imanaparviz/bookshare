                    ...
                    <x-slot name="content">
                        ...
                        <div class="px-3 py-2 border-b border-gray-100 dark:border-gray-600">
                            <div class="flex items-center">
                                ...
                                @else
                                    <div class="h-10 w-10 rounded-full bg-gradient-to-r from-purple-400 to-pink-400 flex items-center justify-center text-white font-semibold text-sm flex-shrink-0">
                                        {{ strtoupper(substr(Auth::user()->name, 0, 2)) }}
                                    </div>
                                @endif
